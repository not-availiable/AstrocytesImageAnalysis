...
stats = {}
centers = []
config_path = ""  # New global variable to store config path
...
# Code to get stats
def get_stats(nucDat, rois, x, ally, shockwavedCell, config_path_arg):
    global config_path
    config_path = config_path_arg  # Store the config path
